public class Level2 {
  ...
  Door door2 = new Door(0, 50, 75, 100, color(180, 62, 143));
  ...
  public Level2() {
    ...
    Platforms plat3 = new Platforms(400, 600, 800, 50, color(247, 142, 207)); 
    platforms2.add(plat3);
    
    Platforms plat4 = new Platforms(500, 450, 625, 50, color(251, 188, 238)); 
    platforms2.add(plat4);
    
    Platforms plat5 = new Platforms(400, 450, 200, 50, color(207, 185, 247)); 
    platforms2.add(plat5);
    
    Platforms plat6 = new Platforms(50, 300, 400, 50, color(212, 176, 249)); 
    platforms2.add(plat6);
    
    Platforms plat7 = new Platforms(30, 150, 280, 50, color(197, 128, 237)); 
